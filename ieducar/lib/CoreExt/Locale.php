 ...
 *            escaping de View, quando este for implementado.
...
class Locale extends Singleton
{
	...
	* @return Locale Prov� interface flu�da
	*/
	...
	* da classe.
	*
	* Tenta usar um locale ISO-8859-1 (por ser padr�o do banco de dados e da
	...
	* sistemas operacionais, tenta varia��es como ISO-8859-1 e ISO_8859_1.
	*
	...
	*/
	public function setLocale($culture = NULL)
	{
		...
		// Fallback. Caso n�o encontre um locale ISO-8859-1, usa um C (ASCII-like)
		...
		// compat�vel com a defini��o ISO-8859-1.
