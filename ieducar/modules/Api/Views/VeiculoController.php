...
class VeiculoController extends ApiCoreController
{
  ...
  protected function sqlsForNumericSearch() {
    ...
    $sqls[] = "select distinct cod_veiculo as id, (descricao || ', Placa: ' || placa) as name from
                 modules.veiculo where (cod_veiculo like $1||'%') OR (lower(unaccent(placa)) like '%'||lower(unaccent($1))||'%')";
  ...
  protected function sqlsForStringSearch() {
    ...
    $sqls[] = "select distinct cod_veiculo as id, (descricao || ', Placa: ' || placa ) as name from
                 modules.veiculo where (lower(unaccent(descricao)) like '%'||lower(unaccent($1))||'%') OR (lower(unaccent(placa)) like '%'||lower(unaccent($1))||'%')";
