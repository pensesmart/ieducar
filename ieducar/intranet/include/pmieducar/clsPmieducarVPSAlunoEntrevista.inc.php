...
class clsPmieducarVPSAlunoEntrevista
{
	 ...
	 * @return object
	 */
	function clsPmieducarVPSAlunoEntrevista($cod_vps_aluno_entrevista = null, $ref_cod_vps_entrevista = null, $ref_cod_aluno = null, $resultado_entrevista = null, $ativo = null,
		$inicio_vps = null, $termino_vps = null, $insercao_vps = null, $ref_usuario_exc = null, $ref_usuario_cad = null, $motivo_termino = null, $data_cadastro = null, $data_exclusao = null)
	{
		$db = new clsBanco();
	...
	function edita()
	{
		if((is_numeric($this->ref_cod_aluno) && is_numeric($this->ref_cod_vps_entrevista)) || is_numeric($this->cod_vps_aluno_entrevista))
		{
			...
			if($set)
			{
				...
				else if(is_numeric($this->cod_vps_aluno_entrevista))
	 ...
	 * @return array
	 */
	function listaData($data_entrevista_inicio = null, $data_entrevista_final = null, $int_resultado_entrevista = null)
	{
		$filtros = '';
		$this->resetCamposLista();
